...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <a
      ...
      className="group flex flex-col gap-3.5 rounded-lg border bg-card p-4 outline-none transition-colors hover:bg-secondary/40 hover:border-foreground/20 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
    >
