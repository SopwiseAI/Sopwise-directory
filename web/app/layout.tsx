...
export const metadata: Metadata = {
  title: { default: "ailulu - AI 产品书签", template: "%s - ailulu" },
  description: "发现和探索最好的 AI 产品，ailulu 为你精选各类 AI 工具和应用",
  keywords: ["AI", "AI产品", "AI工具", "人工智能", "书签", "AI导航"],
  openGraph: {
    title: "ailulu - AI 产品书签",
    description: "发现和探索最好的 AI 产品，ailulu 为你精选各类 AI 工具和应用",
    siteName: "ailulu",
    locale: "zh_CN",
    type: "website",
...
const sidebarScript = `(function(){try{var c=localStorage.getItem("ailulu:sidebar-collapsed")==="true";document.documentElement.setAttribute("data-sidebar",c?"collapsed":"expanded")}catch(e){document.documentElement.setAttribute("data-sidebar","expanded")}})()`;
